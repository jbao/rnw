...
<<label=filter,echo=False,fig=FALSE,cache=True,eval=True>>=
...
<<label=logistic,echo=False,fig=False,eval=True>>=
# logistic fit
library(minpack.lm)
...
<<label=hppi,echo=False,fig=False,cache=True,eval=True>>=
